/*---------------------------------------------------------------------------------------------
 *  Adapted from the official Copilot source (vscode-1.133.0):
 ...
 */
function tryRebaseAsCursorEdit(
	cursorPos: Position,
	doc: TextDocument,
	range: Range,
	newText: string,
	...
	const editedText =
		doc.getText(new Range(affectedStart, range.start)) +
		newText +
		doc.getText(new Range(range.end, affectedEnd));
